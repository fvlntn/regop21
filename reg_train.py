            ...
            for i, data in enumerate(dataloaders[phase]):
                ...
                with torch.set_grad_enabled(phase == 'train'):
                    ...
                    if sym:
                        ...
                        metric_logger.updates(["sym_img_loss", "sym_ddf_loss", "sym_inv_loss"], [sym_img_loss.item(), sym_ddf_loss.item(), sym_inv_loss.item()])
...
def parseArguments():
    ...
    parser.add_argument("-p", "--patience", type=int, default=30, help="Specify patience for LR Plateau.")
